...
class JacoController(Node):
    ...
    def find_rotation_pose(self, joy_msg:Joy):
        ...
        orientation_x = (joy_msg.buttons[5] - joy_msg.buttons[4]) * MAX_ROTATION_CHANGE + (pitch * ROTATION_ASSISTANCE)
        orientation_y = (-joy_msg.axes[3] * MAX_ROTATION_CHANGE)  
        orientation_z = (-joy_msg.axes[4] * MAX_ROTATION_CHANGE) + (roll * ROTATION_ASSISTANCE)
    ...
    def find_rotation_velocity(self, quaternion_target:Rotation, quaternion_current:Rotation):
        ...
        euler_velocity_target[2] = self.rotation_euler_target[2] * MAX_ANGULAR_VELOCITY # good!
