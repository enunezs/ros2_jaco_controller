...
MAX_LINEAR_VELOCITY = 0.1250    # m/s
...
RELATIVE_CARTESIAN_MOVEMENT_ENABLED = True
...
class JacoController(Node):
    ...
    def find_rotation_pose(self, joy_msg:Joy) -> Rotation:
        ...
        orientation_change[0] = (joy_msg.buttons[5] - joy_msg.buttons[4]) 
        orientation_change[1] = (-joy_msg.axes[3] )  
        orientation_change[2] = (-joy_msg.axes[4] ) 
