...
MAX_POSITION_CHANGE = 0.01
MAX_ROTATION_CHANGE = 0.01
...
class JacoController(Node):
    ...
    def update_controller(self):
        ...
        target_vel = [ K_P * error[0], K_P * error[1], K_P * error[2] , 0.0, 0.0, 0.0, 0.0 ] # force in unit m/s, rad/s
        ...
        # Alt approach, use action client for velocity
        #self.vel_client = ActionClient(self, PoseVelocity, '/j2n6s300_driver/pose_velocity')
